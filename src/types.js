...
export const stdlibTypes = {
    ...
    ts_from_date: createPolyFn([
        [S, N, N, N, N, union([Timestamp, U])],
        [S, S, N, N, N, union([Timestamp, U])],
        [any(), any(), any(), any(), any(), U],
    ]),
    ts_to_date: createPolyFn([
        [Timestamp, N, S],
        [Timestamp, S, S],
        [any(), any(), U],
    ]),
    ...
    ts_get: createPolyFn([
        [S, N, Timestamp, union([N, U])],
        [S, S, Timestamp, union([N, U])],
        [any(), any(), any(), U],
    ]),
    ts_set: createPolyFn([
        [S, N, Timestamp, N, union([Timestamp, U])],
        [S, S, Timestamp, N, union([Timestamp, U])],
        [any(), any(), any(), any(), U],
    ]),
